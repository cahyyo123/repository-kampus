...
export default function AdminAddDocument() {
  ...
  const handleAddCustomFile = () => {
    setCustomFiles([...customFiles, { id: `custom_file_${Date.now()}`, label: '' }]);
  };
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.success) {
        alert(`Dokumen berhasil ditambahkan dengan kode: ${data.document_code}`);
        navigate('/admin/dashboard');
      } else {
        alert(data.message || 'Gagal menambahkan dokumen');
      }
    } catch (err) {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Tambah Dokumen Baru</h1>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <textarea
                ...
                placeholder="Tuliskan abstrak dokumen..."
              ></textarea>
            </div>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
                placeholder="Contoh: sistem informasi, web, repository"
              />
            </div>
            ...
            <div className="col-span-1 md:col-span-2 bg-indigo-50 p-4 rounded-xl border border-indigo-100 flex flex-col gap-2 relative">
